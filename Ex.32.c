...
int usageHistory[MAX_FRAMES]; // To store the usage history ofpages for (int i = 0; i < MAX_FRAMES; i++) {
...
// Find the page with the maximum usage counter (least recently int lruPage = 0;
